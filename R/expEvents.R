#' Expected number of events by DCO for each arm with the specified survival distribution
#' 
...
#' @export
#' 
expEvents = function(DCO = 40, f=fa, Fentry=function(t){(t/24)^2*as.numeric(t<24)+as.numeric(t>=24)}, drop.rate = 0.03/12, n = 300){
